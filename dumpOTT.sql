...
--
-- Table structure for table `bulkupload_log`
--

DROP TABLE IF EXISTS `bulkupload_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bulkupload_log` (
  `bid` int(11) NOT NULL AUTO_INCREMENT,
  `puser_id` varchar(10) DEFAULT NULL,
  `file_name` varchar(255) DEFAULT NULL,
  `kaltura_job_id` varchar(15) DEFAULT NULL,
...
CREATE TABLE `coupon_history` (
  ...
  `discount_percentage` decimal(15,4) DEFAULT NULL,
  `date_added` datetime NOT NULL,
  `coupon_code` varchar(25) DEFAULT NULL,
  `coupon_discount` varchar(10) DEFAULT NULL,
...
--
-- Table structure for table `coupon_video`
--
...
CREATE TABLE `currency_conversion` (
  ...
  `status` enum('0','1') DEFAULT NULL,
  `conversion_rate` varchar(10) DEFAULT NULL,
...
CREATE TABLE `entry` (
  ...
  `currency_data` text,
  `custom_data` text,
  `sync` enum('0','1','2') DEFAULT '0',
  `age_limit` varchar(45) DEFAULT 'UA',
  PRIMARY KEY (`entryid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
--
-- Dumping data for table `filter_setting`
--

LOCK TABLES `filter_setting` WRITE;
/*!40000 ALTER TABLE `filter_setting` DISABLE KEYS */;
INSERT INTO `filter_setting` VALUES (3,'category','category_level','3',0,'1',NULL,NULL,NULL),(8,'Pay per View','pay_per_view','5',NULL,'1','hour','2018-07-09 11:39:15','2018-07-09 12:20:57'),(9,'GST','gst','22',NULL,'1','P','2018-07-09 11:45:34','2018-07-09 12:20:49');
/*!40000 ALTER TABLE `filter_setting` ENABLE KEYS */;
UNLOCK TABLES;
--
...
CREATE TABLE `header_menu` (
  ...
  `header_status` enum('1','0','3') DEFAULT NULL,
  `priority` int(11) DEFAULT NULL,
  `added_date` varchar(45) DEFAULT NULL,
...
CREATE TABLE `offers` (
  ...
  `uses_customer` varchar(11) DEFAULT NULL,
...
CREATE TABLE `ticket` (
  ...
  `ticket_tag` varchar(5) DEFAULT NULL,
  `ticket_sub` varchar(100) DEFAULT NULL,
  `ticket_msg` varchar(255) DEFAULT NULL,
  `userid` int(11) DEFAULT NULL,
  `ticket_status` varchar(20) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `inprocess_at` datetime DEFAULT NULL,
...
CREATE TABLE `user_payment_details` (
  ...
  `payment_for` varchar(10) DEFAULT NULL,
...
CREATE TABLE `voucher_history` (
  ...
  `currency_used` int(11) DEFAULT NULL,
  `currency_trans_id` varchar(50) DEFAULT NULL,
  `countrycode` varchar(5) DEFAULT NULL,
  `total_points` int(11) DEFAULT NULL,
  `gift_use_status` varchar(5) DEFAULT NULL,
  `unique_coupon_code` varchar(10) DEFAULT NULL,
...
CREATE TABLE `wallet_trans_info` (
  ...
  `total_point_used` varchar(5) DEFAULT NULL,
...
-- Dump completed on 2018-08-04 10:14:30
