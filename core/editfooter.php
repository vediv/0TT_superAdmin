...
$result_2= $mysqli->query($query1);
$query2=mysqli_fetch_array($result_2);
//$id=$query2['f_id'];
?>
  	 ...
  	 <form class="form-horizontal" role="form" action="#" method="post" ><br/>
									...
									<div class="col-md-10">
										<select class="form-control" name="year" style="width:450px" >
										    <option  class="form-control" value="<?php echo $query2['f_year']; ?>"><?php echo $query2['f_year']; ?></option>
                                    ...
                                    <div class="form-group"> <br/>
									      ...
									      <div class="col-md-10"> 
									        <input type="text" style="width:450px" class="form-control" name="content"  value="<?php echo $query2['f_content']; ?>" required/>
									      </div>	
									    </div>
							<br/>
									      ...
									      <div class="col-md-10"> 
									        <input type="url" style="width:450px" class="form-control" name="url"  value="<?php echo $query2['f_hyperlink']; ?>" required/>
