...
<link rel="stylesheet" href="js/bootstrap-multiselect.css" type="text/css"/>
     <div class="modal-header">
        ...
        <div class="form-group">
          ...
          <div class="pull-right" style="border: 1px solid white; width: 45%; margin-right: 10px;">
          	
            <iframe bordercolor="white" frameborder="0" src="play_preview.php?Entryid=<?php echo $Entryid; ?>" width="100%" height="240">
