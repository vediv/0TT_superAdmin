...
CREATE TABLE `content_partner` (
  `contentpartnerid` varchar(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `publisher_setting`
--

LOCK TABLES `publisher_setting` WRITE;
/*!40000 ALTER TABLE `publisher_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `publisher_setting` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `slider_image_detail` (
  ...
  `slider_category` enum('1','2','7') DEFAULT NULL,
...
CREATE TABLE `user_registration` (
  ...
  `ure_password` varchar(255) DEFAULT NULL,
...
CREATE TABLE `userinfo` (
  ...
  `sim_location` varchar(30) DEFAULT NULL,
  `sim_operator` varchar(30) DEFAULT NULL,
...
-- Dump completed on 2017-08-18 10:40:07
